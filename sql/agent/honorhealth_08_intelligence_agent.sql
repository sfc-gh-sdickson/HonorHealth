...
CREATE OR REPLACE AGENT HONORHEALTH_CARE_AGENT
  ...
  instructions:
    ...
    orchestration: "For patient health outcomes and care quality questions use SV_PATIENT_HEALTH_OUTCOMES. For social determinants of health analysis use SV_SOCIAL_DETERMINANTS. For value-based care performance metrics use SV_VALUE_BASED_CARE. For clinical notes search use CLINICAL_NOTES_SEARCH. For care plans and treatment protocols use CARE_PLANS_SEARCH. For health policies and guidelines use HEALTH_POLICIES_SEARCH. For ML predictions use the appropriate prediction function."
